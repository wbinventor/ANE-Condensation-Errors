...
casmo['12-group'].group_edges = group_edges * 1e6
...
casmo['16-group'].group_edges = group_edges * 1e6
...
casmo['18-group'].group_edges = group_edges * 1e6
...
casmo['25-group'].group_edges = group_edges * 1e6
...
group_edges = np.array([0., 0.015e-6, 0.03e-6, 0.042e-6,
                        ...
                        9.118e-3, 111.e-3, 500.e-3, 821.e-3,
                        1.353, 2.231, 3.679, 6.0655, 20.])
casmo['40-group'].group_edges = group_edges * 1e6
...
casmo['70-group'].group_edges = group_edges * 1e6
